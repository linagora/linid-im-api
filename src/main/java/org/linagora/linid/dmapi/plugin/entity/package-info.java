...
/**
 * Contains the model and related interfaces for representing dynamic entities within the LinID Directory Manager.
 */
package org.linagora.linid.dmapi.plugin.entity;
