...
package org.linagora.linid.dmapi;

import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;

/**
 * Entry point for the LinID Directory Manager API Spring Boot application.
 *
...
public class DirectoryManagerApiApplication {
  ...
  public static void main(String[] args) {
    SpringApplication.run(DirectoryManagerApiApplication.class, args);
  }
